...
public class SetPersonalDetailsTest1 extends Base {

    Logger log = Logger.getLogger(SetPersonalDetailsTest1.class);

    // clicking on the next button with out filling any details.......
    @Test
