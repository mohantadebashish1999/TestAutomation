...
public class SetPasswordTest4 extends Base {
    Logger log = Logger.getLogger(SetPasswordTest4.class);
    ...
    public void setValidPassword() throws InterruptedException {
       ...
       // setpasswordpage.setPassword("Demo");
        ...
        String errorMsg2 = setpasswordpage.captureErrorMessage2();
        
        log.info("error message is : "+errorMsg);
        log.info("error message is : "+errorMsg2);
        try
        {
